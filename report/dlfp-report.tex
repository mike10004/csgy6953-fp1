...
As shown in~\ref{fig:onemark-loss-df}, the loss curves are TODO .

As shown in~\ref{fig:onemark-loss-dropout}, the loss curves are TODO .
...
As shown in~\ref{fig:charmark-loss-df}, the loss curves are TODO .

As shown in~\ref{fig:charmark-loss-dropout}, the loss curves are TODO .
